...
#define VDD_0_PS		(VDD__0__PS)
#define VDD_0_PC		(VDD__0__PC)
#define VDD_0_DR		(VDD__0__DR)
#define VDD_0_SHIFT	(VDD__0__SHIFT)
#define VDD_0_INTR	((uint16)((uint16)0x0003u << (VDD__0__SHIFT*2u)))
