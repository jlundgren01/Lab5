// ======================================================================
// PSoC_4_BLE_Pressure_Sensor.v generated from TopDesign.cysch
// 11/22/2016 at 11:57
...
module BLE_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("e6974270-005a-4bd4-950a-233696692c60/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
    ...
    cy_annotation_universal_v1_0 GND1 (
        .connect({
            Net_4005
        })
    );
    defparam GND1.comp_name = "Gnd_v1_0";
    defparam GND1.port_names = "T1";
    defparam GND1.width = 1;

	wire [0:0] tmpOE__VDD_net;
	wire [0:0] tmpFB_0__VDD_net;
	wire [0:0] tmpIO_0__VDD_net;
	wire [0:0] tmpINTERRUPT_0__VDD_net;
	electrical [0:0] tmpSIOVREF__VDD_net;

	cy_psoc3_pins_v1_10
		#(.id("e71c0b8e-165e-43e8-8601-79c029a722ae"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VDD
		 (.oe(tmpOE__VDD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VDD_net[0:0]}),
		  .io({tmpIO_0__VDD_net[0:0]}),
		  .siovref(tmpSIOVREF__VDD_net),
		  .interrupt({tmpINTERRUPT_0__VDD_net[0:0]}),
		  .annotation({Net_3993}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__VDD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("0a053fa2-75b9-4525-a048-11843d0922cd"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 VDD2 (
        .connect({
            Net_3993
        })
    );
    defparam VDD2.comp_name = "Power_v1_0";
    defparam VDD2.port_names = "T1";
    defparam VDD2.width = 1;

    cy_annotation_universal_v1_0 GND2 (
        .connect({
            Net_3994
        })
    );
    defparam GND2.comp_name = "Gnd_v1_0";
    defparam GND2.port_names = "T1";
    defparam GND2.width = 1;
